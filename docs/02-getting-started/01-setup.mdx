...
If your platform is not supported, please [create an issue on GitHub](https://github.com/calimero-network/core/issues).
...
- Ensure Rust is installed. If not, follow the instructions on the [Rust website](https://www.rust-lang.org/tools/install).
...
For further support, open an issue on [GitHub](https://github.com/calimero-network/core/issues).
