...
> we support Internet Computer (ICP), Starknet and NEAR protocol. By default, the protocol is set to NEAR
> protocol, but you can set it explicitly to Starknet or ICP by using the following
> commands:
>
> ```bash title="Terminal"
