...
- `POST /admin-api/alias/create/context` - Generate context identity
- `POST /admin-api/alias/create/application` - Generate context identity
- `POST /admin-api/alias/create/identity/:context` - Generate context identity
