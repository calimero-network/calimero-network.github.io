...
(ABI) for your Calimero applications, enabling seamless integration across
multiple blockchain protocols including Ethereum, NEAR, ICP, and Starknet.
...
- **Cross-Protocol Compatibility**: Write once, deploy everywhere across
  different blockchain protocols
- **Type Safety**: Compile-time validation ensures your application interfaces
  are correct
...
- **Type Checking**: Ensures all types are compatible across protocols
- **Method Validation**: Verifies method signatures and return types
- **Event Validation**: Validates event structures and parameters
- **ABI Conformance**: Guarantees generated ABI meets protocol standards
...
ABI Generation automatically handles protocol-specific optimizations:

### Ethereum

- Gas-optimized method calls
- Event logging with indexed parameters
- Solidity-compatible type mapping
- EIP-712 signature support

### NEAR Protocol

- Account-based method calls
- Storage optimization for large data
...
Generate type-safe client code from your ABI:
