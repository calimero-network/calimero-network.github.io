...
:::tip If you create an Context Alias for your context using
...
```bash title="Node 1"
context invite {contextId} {inviteeContextIdentity} --as {inviterContextIdentity}
```

```bash title="Example"
context invite 567C5Gg4mxHMPKy2wLJ4uvb3DHsbcpVDYUsuAWgTPgXn 3yBQQvn2G8ghWk2ZwmLFYxJQgM1YmDtiigi84nGpZBb9 --as DaSkad6DK7f6fUhjz1CvNW7L4TkWZmWqAcwysZHG3Xs5
