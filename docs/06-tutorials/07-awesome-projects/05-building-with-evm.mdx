...
Context contract is deployed on Ethereum sepolia network and implemented into Calimero.
...
These types are used to define the parameters and return values of smart contract functions in Ethereum-based blockchains.
