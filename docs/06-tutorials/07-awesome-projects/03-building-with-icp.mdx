...
<lb/>
More information about context contract can be found [here](/core-concepts/blockchain-integration).
...
<lb/>
More information about proxy contract can be found [here](/core-concepts/blockchain-integration).
