...
5. **Installing a Blockchain Demo Application** - Setup demo application that contains all 
   functionalities for interaction with smart contracts.
...
Script is implemented in a way that it deletes current dfx enviroment and creates new one. 
This will delete all previous setups and deployed smart contracts.
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/2_devnet_script_finish.png" alt="FinishDevnetScript" />
  </p>
</details>
...
<details>
  ...
  <img src="/icp-tutorial/8_greet_deploy.png" alt="deploy-terminal-output" />
    > <br/>
    > Save the `canister ID` as you
    > will need it later to call its query and mutate methods.
    >
...
<details>
  <summary>Query terminal output image</summary>
  <p>
  <img src="/icp-tutorial/10_test_query_core.png" alt="query-terminal-output" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/13_verify_node_config.png" alt="nodes-configuration" />
    > <br />
...
<details>
  <summary>Application install and create context terminal output image</summary>
  <p>
...
<details>
  ...
  > <br/>
  > We get value of
  > proxy contract id which is: `b77ix-eeaaa-aaaaa-qaada-cai`
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/23_start_blockchain_demo_app.png" alt="running-demo-app" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/26_proposal_popup_1.png" alt="create-proposal-popup" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/30_proposal_popup_2.png" alt="approve-proposal-popup" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/32_execute_proposal_node3.png" alt="execute-proposal-popup" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/33_create_cross_call_proposal.png" alt="create-ccc" />
  </p>
</details>
...
<details>
  <summary>Proposal executed popup image</summary>
  <p>
  <img src="/icp-tutorial/34_proposal_popup_3.png" alt="proposal-executed-popup" />
  </p>
</details>
...
<details>
  ...
  <p>
  <img src="/icp-tutorial/35_verify_change_method.png" alt="get-greet-image" />
  </p>
</details>

> We can see in
> terminal the first time we used command output was: Hello, world! And after
> proposal was executed greet was changed to: Hello, calimero!
