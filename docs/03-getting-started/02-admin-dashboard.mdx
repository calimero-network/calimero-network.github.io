...
Before you start you need to install dependencies and build the Admin Dashboard
UI.
...
Run the node following the setup in [Getting-started](./01-setup.mdx) and Admin
dashboard is now available at `http://localhost:NODE_PORT/admin-dashboard/`.
