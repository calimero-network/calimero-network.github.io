...
Navigate to [Admin Dashboard](../getting-started/admin-dashboard) and select
`Applications` tab.
...
We have used GitHub Pages to preview our
[example app](../getting-started/example-app). You can do the same by following
the steps below.
